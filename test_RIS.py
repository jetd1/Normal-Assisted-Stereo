...
from data_loader import SequenceFolderRIS as SequenceFolder
    ...
    with torch.no_grad():
        for i, (tgt_img, ref_imgs, gt_nmap, ref_poses, intrinsics, intrinsics_inv, tgt_depth) in enumerate(val_loader):
            ...
            if args.output_print:
                ...
                plt.imsave(output_dir/'{:04d}_gtdepth{}'.format(i,'.png'), tgt_depth.numpy()[0], cmap='rainbow')
